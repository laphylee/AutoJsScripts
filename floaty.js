...
const but_data = {
    ...
    'menu_1': {
        name: "search",
        src: "https://s2.ax1x.com/2019/07/05/ZdO63t.png",
        bg: "#009687"
    },
    'menu_2': {
        name: "google",
        src: "https://s2.ax1x.com/2019/07/05/ZdOMBF.png",
        bg: "#ee534f"
    },
    'menu_3': {
        name: "douban",
        src: "https://s2.ax1x.com/2019/07/05/ZdOKnU.png",
        bg: "#40a5f3"
    },
    'menu_4': {
        name: "etyma",
        src: "https://s2.ax1x.com/2019/07/05/ZdOQ74.png",
        bg: "#fbd834"
    },
    'menu_4a': {
        name: "wechat",
        src: "https://s2.ax1x.com/2019/07/05/ZdXY5j.png",
        bg: "#243d20"
    },
    'menu_5': {
        name: "设置",
...
function menuOnClick(view) {
    ...
    switch (view._name.text()) {
        case "search":
            engines.execScriptFile("/storage/emulated/0/Scripts/Search.js");
            break;
        case "google":
...
var w_menu = floaty.rawWindow(
    <frame id="menu" w="{{dp2px(menu_r)}}px" h="{{dp2px(menu_r)}}px" visibility="gone" >//
        ...
        <butLogo-layout name="{{but_data.menu_4a.name}}" src="{{but_data.menu_4a.src}}" bg="{{but_data.menu_4a.bg}}" layout_gravity="center" />
